 ...
 *
 * This particle effect library was created by DarkBlade12 based off content
 * from microgeek You are free to use it, modify it and redistribute it under
 * the condition to give credit to me and microgeek
 *
 * @author DarkBlade12
 */
public enum Particle
{
    ...
    private Object createNormalPacket(Particle effect, Location loc, float offsetX, float offsetY, float offsetZ, float speed, int amount)
    {
